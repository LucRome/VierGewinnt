...
std::shared_ptr<Spielsteine> Regelwerk::waagerechtCheck(std::shared_ptr<Spielfeld> spielfeld, std::shared_ptr<Spielsteine> meinStein)
{
	int zähler = 0;
	int max_zähler = 0;
...
std::shared_ptr<Spielsteine> Regelwerk::senkrechtCheck(std::shared_ptr<Spielfeld> spielfeld, std::shared_ptr<Spielsteine> meinStein)
{
	int zähler = 0;
	int max_zähler = 0;
	std::shared_ptr<Spielsteine> jetztDa;
...
std::shared_ptr<Spielsteine> Regelwerk::diagonalCheck(std::shared_ptr<Spielfeld> spielfeld, std::shared_ptr<Spielsteine> meinStein)
{
	int zähler = 0;
	int max_zähler = 0;
	std::shared_ptr<Spielsteine> jetztDa;
